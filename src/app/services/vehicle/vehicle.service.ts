...
export class VehicleService {
  ...
  /**
   * Récupère la liste des véhicules d'un lieu donné.
   * @param placeId L'identifiant du lieu.
   * @returns Un Observable contenant un tableau de véhicules.
   */
  getVehiclesByPlaceId(placeId: number): Observable<Vehicle[]> {
      return this.http.get<Vehicle[]>(`${this.apiUrl}/byPlace${placeId}`);
  }
